export default function Hero() {
  return (
    <section>
      <div className="container mx-auto flex flex-col items-center px-5 py-16 md:flex-row md:px-12 md:py-24 lg:px-20">
        <div className="mb-16 flex flex-col items-center text-center md:mb-0 md:w-1/2 md:items-start md:text-left lg:flex-grow lg:pr-24">
          <div className="mx-auto max-w-7xl px-4 pb-16 pt-20 sm:px-6 lg:px-8 lg:pt-32">
            <div className="my-4 text-4xl font-extrabold sm:text-5xl lg:text-6xl">
            ...
            <h1 className="font-display mx-auto max-w-4xl text-3xl font-medium tracking-tight sm:text-6xl lg:text-7xl">
              <span className="inline-block">
                ...
                <span className="relative whitespace-nowrap text-blue-600">
                  ...
                  <span className="relative"> Your Rental Needs</span>
                </span>
              </span>
            </h1>
          </div>
