...
import { AlertCircle, Eye, EyeOff, Lock, Mail, MapPin, Phone, User, UserPlus } from "lucide-react"
      ...
      <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-zinc-50 to-neutral-100 dark:from-zinc-900 dark:to-neutral-900">
        <Card className="max-w-md w-full p-8 text-center shadow-xl border-0 dark:bg-zinc-800/50 backdrop-blur-sm">
          <div className="rounded-full bg-green-100 dark:bg-green-900/30 w-16 h-16 flex items-center justify-center mx-auto mb-4">
            <AlertCircle size={32} className="text-green-600 dark:text-green-400" />
          </div>
    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-zinc-50 to-neutral-100 dark:from-zinc-900 dark:to-neutral-900">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-300">Join RentEase to find your perfect rental home</p>
        </div>
        ...
        <Card className="py-8 shadow-xl border-0 dark:bg-zinc-800/50 backdrop-blur-sm">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <Button
              ...
              fullWidth
              disabled={loading}
              className="group relative flex justify-center py-3 mt-6 transition-all duration-300"
            >
              {loading ? (
                ...
                <span className="flex items-center">
                  <UserPlus
                    size={18}
                    className="mr-2 group-hover:translate-y-[-2px] transition-transform duration-300"
                  />
                  Create Account
                </span>
              )}
